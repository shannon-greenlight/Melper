...
rem "%bin_dir%\python" "%plugin_dir%/bom_lcsc.py" "Melper.xml" "bom\LCSC\Melper_bom.csv"

rem "%bin_dir%\python" "%plugin_dir%/bom_digikey_split.py" "Melper.xml" "bom\Digi-Key\Melper_split.csv"

"%bin_dir%\python" "%plugin_dir%/bom_digikey_full.py" "Melper.xml" "bom\Digi-Key\Melper_full.csv"
